...
#	elif (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) // C99 detected, x64 bit types available
...
#		pragma message("GLM: x86 x64 bits with AVX2 instruction set build target")
...
#		pragma message("GLM: x86 x64 bits with AVX instruction set build target")
...
#		pragma message("GLM: x86 x64 bits with SSE4.2 instruction set build target")
...
#		pragma message("GLM: x86 x64 bits with SSE4.1 instruction set build target")
...
#		pragma message("GLM: x86 x64 bits with SSSE3 instruction set build target")
...
#		pragma message("GLM: x86 x64 bits with SSE3 instruction set build target")
...
#		pragma message("GLM: x86 x64 bits with SSE2 instruction set build target")
...
#		pragma message("GLM: x86 x64 bits build target")
#	elif (GLM_ARCH & GLM_ARCH_X86_BIT) && (GLM_MODEL == GLM_MODEL_32)
#		pragma message("GLM: x86 32 bits build target")

#	elif (GLM_ARCH & GLM_ARCH_NEON_BIT) && (GLM_MODEL == GLM_MODEL_64)
#		pragma message("GLM: ARM x64 bits with Neon instruction set build target")
...
#		pragma message("GLM: PowerPC x64 bits build target")
