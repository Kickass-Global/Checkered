 ...
 */
FT_EXPORT(FT_Error) FT_Outline_New(
 ...
 *   will be released.
 */
FT_EXPORT(FT_Error) FT_Outline_Done(
 ...
 */
FT_EXPORT(void) FT_Outline_Get_CBox(
 ...
 *     The vertical offset.
 */
FT_EXPORT(void) FT_Outline_Translate(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FT_Outline_Copy(
 ...
 *   outline's points.
 */
FT_EXPORT(void) FT_Outline_Transform(
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Outline_Embolden(
 ...
 *   2.4.10
 */
FT_EXPORT(FT_Error) FT_Outline_EmboldenXY(
 ...
 */
FT_EXPORT(FT_Error) FT_Outline_Get_Bitmap(
