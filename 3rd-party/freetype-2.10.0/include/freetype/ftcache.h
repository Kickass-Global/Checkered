...
typedef FT_Error
(*FTC_Face_Requester)(
    FTC_FaceID face_id, FT_Library library, FT_Pointer req_data, FT_Face *aface
);
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FTC_Manager_New(
 ...
 *   operation.
 */
FT_EXPORT(FT_Error) FTC_Manager_LookupFace(
 ...
 *
 */
FT_EXPORT(void) FTC_Manager_RemoveFaceID(
 ...
 *
 */
FT_EXPORT(FT_Error) FTC_CMapCache_New(
    FTC_Manager manager, FTC_CMapCache *acache
);
 ...
 *
 */
FT_EXPORT(FT_UInt) FTC_CMapCache_Lookup(
    FTC_CMapCache cache, FTC_FaceID face_id, FT_Int cmap_index, FT_UInt32 char_code
);
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FTC_ImageCache_New(
 ...
 *   persistent!
 */
FT_EXPORT(FT_Error) FTC_ImageCache_Lookup(
 ...
 */
FT_EXPORT(FT_Error) FTC_ImageCache_LookupScaler(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FTC_SBitCache_New(
 ...
 *   persistent!
 */
FT_EXPORT(FT_Error) FTC_SBitCache_Lookup(
    FTC_SBitCache cache, FTC_ImageType type, FT_UInt gindex, FTC_SBit *sbit, FTC_Node *anode
);
 ...
 *   persistent!
 */
FT_EXPORT(FT_Error) FTC_SBitCache_LookupScaler(
    FTC_SBitCache cache, FTC_Scaler scaler, FT_ULong load_flags, FT_UInt gindex, FTC_SBit *sbit, FTC_Node *anode
);
