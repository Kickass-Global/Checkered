 ...
 *   overlap.
 */
FT_EXPORT(FT_Error) FT_Bitmap_Copy(
 ...
 */
FT_EXPORT(FT_Error) FT_Bitmap_Embolden(
 ...
 *   2.10
 */
FT_EXPORT(FT_Error) FT_Bitmap_Blend(
    FT_Library library, const FT_Bitmap *source, const FT_Vector source_offset, FT_Bitmap *target,
 ...
 *   handling functions.
 */
FT_EXPORT(FT_Error) FT_Bitmap_Done(
