 ...
 */
FT_EXPORT(FT_Error) FT_TrueTypeGX_Validate(
 ...
 */
FT_EXPORT(void) FT_TrueTypeGX_Free(
 ...
 */
FT_EXPORT(FT_Error) FT_ClassicKern_Validate(
 ...
 */
FT_EXPORT(void) FT_ClassicKern_Free(
    FT_Face face, FT_Bytes table
);
