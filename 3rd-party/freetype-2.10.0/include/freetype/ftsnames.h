 ...
 *   `TT_CONFIG_OPTION_SFNT_NAMES` is not defined in `ftoption.h`.
 */
FT_EXPORT(FT_Error) FT_Get_Sfnt_Name(
    FT_Face face, FT_UInt idx, FT_SfntName *aname
);
 ...
 *   2.8
 */
FT_EXPORT(FT_Error) FT_Get_Sfnt_LangTag(
    FT_Face face, FT_UInt langID, FT_SfntLangTag *alangTag
);
