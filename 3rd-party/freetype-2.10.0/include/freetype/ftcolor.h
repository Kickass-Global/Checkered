 ...
 *   2.10
 */
FT_EXPORT(FT_Error) FT_Palette_Data_Get(
    FT_Face face, FT_Palette_Data *apalette
);
 ...
 *   2.10
 */
FT_EXPORT(FT_Error) FT_Palette_Select(
 ...
 *   2.10
 */
FT_EXPORT(FT_Error) FT_Palette_Set_Foreground_Color(
