...
typedef void
(*T1_Field_ParseFunc)(
    FT_Face face, FT_Pointer parser
);
...
(*CFF_Decoder_Get_Glyph_Callback)(
    TT_Face face, FT_UInt glyph_index, FT_Byte **pointer, FT_ULong *length
);

typedef void
(*CFF_Decoder_Free_Glyph_Callback)(
    TT_Face face, FT_Byte **pointer, FT_ULong length
);
...
typedef struct T1_Builder_FuncsRec_ {
    void (*init)(
        T1_Builder builder, FT_Face face, FT_Size size, FT_GlyphSlot slot, FT_Bool hinting
    );
...
typedef enum T1_ParseState_ {
    T1_Parse_Start, T1_Parse_Have_Width, T1_Parse_Have_Moveto, T1_Parse_Have_Path
...
typedef FT_Error
(*T1_Decoder_Callback)(
    T1_Decoder decoder, FT_UInt glyph_index
);


typedef struct T1_Decoder_FuncsRec_ {
    FT_Error (*init)(
        T1_Decoder decoder, FT_Face face, FT_Size size, FT_GlyphSlot slot, FT_Byte **glyph_names, PS_Blend blend,
        FT_Bool hinting, FT_Render_Mode hint_mode, T1_Decoder_Callback callback
    );
    ...
    FT_Error (*parse_metrics)(
        T1_Decoder decoder, FT_Byte *base, FT_UInt len
    );

#endif

    FT_Error (*parse_charstrings)(
...
typedef struct CFF_Decoder_FuncsRec_ {
    void (*init)(
        CFF_Decoder *decoder, TT_Face face, CFF_Size size, CFF_GlyphSlot slot, FT_Bool hinting,
        FT_Render_Mode hint_mode, CFF_Decoder_Get_Glyph_Callback get_callback,
        CFF_Decoder_Free_Glyph_Callback free_callback
    );

    FT_Error (*prepare)(
        CFF_Decoder *decoder, CFF_Size size, FT_UInt glyph_index
    );
...
typedef struct AFM_Parser_FuncsRec_ {
    FT_Error (*init)(
        AFM_Parser parser, FT_Memory memory, FT_Byte *base, FT_Byte *limit
    );
...
typedef struct AFM_ParserRec_ {
    ...
    FT_Int (*get_index)(
        const char *name, FT_Offset len, void *user_data
    );
