...
typedef FT_Error
(*PSH_Globals_NewFunc)(
    FT_Memory memory, T1_Private *private_dict, PSH_Globals *aglobals
);
...
typedef void
(*T1_Hints_ResetFunc)(
    T1_Hints hints, FT_UInt end_point
);
...
typedef FT_Error
(*T1_Hints_ApplyFunc)(
    T1_Hints hints, FT_Outline *outline, PSH_Globals globals, FT_Render_Mode hint_mode
);
...
typedef void
(*T2_Hints_StemsFunc)(
    T2_Hints hints, FT_UInt dimension, FT_Int count, FT_Fixed *coordinates
);
...
typedef void
(*T2_Hints_MaskFunc)(
    T2_Hints hints, FT_UInt end_point, FT_UInt bit_count, const FT_Byte *bytes
);
...
typedef void
(*T2_Hints_CounterFunc)(
    T2_Hints hints, FT_UInt bit_count, const FT_Byte *bytes
);
...
typedef FT_Error
(*T2_Hints_CloseFunc)(
    T2_Hints hints, FT_UInt end_point
);
...
typedef FT_Error
(*T2_Hints_ApplyFunc)(
    T2_Hints hints, FT_Outline *outline, PSH_Globals globals, FT_Render_Mode hint_mode
);
