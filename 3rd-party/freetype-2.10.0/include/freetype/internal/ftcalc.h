 ...
 */
FT_BASE(FT_Long) FT_MulDiv_No_Round(
 ...
 */
FT_BASE(void) FT_Matrix_Multiply_Scaled(
 ...
 */
FT_BASE(void) FT_Vector_Transform_Scaled(
 ...
 */
FT_BASE(FT_Int) ft_corner_orientation(
 ...
 */
FT_BASE(FT_Int) ft_corner_is_flat(
    FT_Pos in_x, FT_Pos in_y, FT_Pos out_x, FT_Pos out_y
);
