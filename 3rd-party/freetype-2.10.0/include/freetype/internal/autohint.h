...
typedef void
(*FT_AutoHinter_GlobalGetFunc)(
    FT_AutoHinter hinter, FT_Face face, void **global_hints, long *global_len
);
...
typedef void
(*FT_AutoHinter_GlobalDoneFunc)(
    FT_AutoHinter hinter, void *global
);
...
typedef void
(*FT_AutoHinter_GlobalResetFunc)(
    FT_AutoHinter hinter, FT_Face face
);
...
typedef FT_Error
(*FT_AutoHinter_GlyphLoadFunc)(
    FT_AutoHinter hinter, FT_GlyphSlot slot, FT_Size size, FT_UInt glyph_index, FT_Int32 load_flags
);
