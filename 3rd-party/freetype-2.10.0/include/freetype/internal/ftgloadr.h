...
FT_BASE(FT_Error) FT_GlyphLoader_New(
    FT_Memory memory, FT_GlyphLoader *aloader
);

/* add an extra points table to a glyph loader */
FT_BASE(FT_Error) FT_GlyphLoader_CreateExtra(FT_GlyphLoader loader);
...
/* to the glyph loader                                                 */
FT_BASE(FT_Error) FT_GlyphLoader_CheckPoints(
...
/* a glyph loader                                                 */
FT_BASE(FT_Error) FT_GlyphLoader_CheckSubGlyphs(
