 ...
 */
FT_BASE(FT_Int) FT_Trace_Get_Count(void);
 ...
 *   components.
 */
FT_BASE(const char*)FT_Trace_Get_Name(FT_Int idx);
 ...
 *   @FT_Trace_Enable.
 */
FT_BASE(void) FT_Trace_Disable(void);
 ...
 *   @FT_Trace_Disable.
 */
FT_BASE(void) FT_Trace_Enable(void);
