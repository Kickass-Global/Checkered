 ...
 *
 */
FT_EXPORT(FT_Error) FT_Get_PS_Font_Info(
    FT_Face face, PS_FontInfo afont_info
);
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Get_PS_Font_Private(
    FT_Face face, PS_Private afont_private
);
 ...
 *
 */
FT_EXPORT(FT_Long) FT_Get_PS_Font_Value(
