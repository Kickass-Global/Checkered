 ...
 */
FT_EXPORT(FT_Error) FT_Stroker_New(
 ...
 *   This function calls @FT_Stroker_Rewind automatically.
 */
FT_EXPORT(FT_Error) FT_Stroker_ParseOutline(
 ...
 */
FT_EXPORT(FT_Error) FT_Stroker_BeginSubPath(
 ...
 *   @FT_Stroker_EndSubPath.
 */
FT_EXPORT(FT_Error) FT_Stroker_LineTo(
 ...
 *   @FT_Stroker_EndSubPath.
 */
FT_EXPORT(FT_Error) FT_Stroker_ConicTo(
 ...
 *   @FT_Stroker_EndSubPath.
 */
FT_EXPORT(FT_Error) FT_Stroker_CubicTo(
 ...
 */
FT_EXPORT(FT_Error) FT_Stroker_GetBorderCounts(
 ...
 *   all borders at once.
 */
FT_EXPORT(void) FT_Stroker_ExportBorder(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FT_Stroker_GetCounts(
 ...
 *     The target outline handle.
 */
FT_EXPORT(void) FT_Stroker_Export(
 ...
 */
FT_EXPORT(FT_Error) FT_Glyph_Stroke(
 ...
 *   account for this added size.
 */
FT_EXPORT(FT_Error) FT_Glyph_StrokeBorder(
