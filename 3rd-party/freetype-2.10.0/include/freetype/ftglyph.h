 ...
 */
FT_EXPORT(FT_Error) FT_Get_Glyph(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FT_Glyph_Copy(
 ...
 *   vector.
 */
FT_EXPORT(FT_Error) FT_Glyph_Transform(
 ...
 *   @FT_GLYPH_BBOX_PIXELS.
 */
FT_EXPORT(void) FT_Glyph_Get_CBox(
 ...
 *   ```
 */
FT_EXPORT(FT_Error) FT_Glyph_To_Bitmap(
 ...
 */
FT_EXPORT(void) FT_Matrix_Multiply(
