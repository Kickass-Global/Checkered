...
FT_EXPORT(FT_Error) FT_New_Face(
    FT_Library library, const char *filepathname, FT_Long face_index, FT_Face *aface
);
 ...
 */
FT_EXPORT(FT_Error) FT_New_Memory_Face(
 ...
 *   ```
 */
FT_EXPORT(FT_Error) FT_Open_Face(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FT_Attach_File(
 ...
 *   stream attachments.
 */
FT_EXPORT(FT_Error) FT_Attach_Stream(
 ...
 */
FT_EXPORT(FT_Error) FT_Select_Size(
 ...
 *   Don't use this function if you are using the FreeType cache API.
 */
FT_EXPORT(FT_Error) FT_Request_Size(
 ...
 *   to @FT_Load_Glyph.
 */
FT_EXPORT(FT_Error) FT_Load_Char(
 ...
 */
FT_EXPORT(void) FT_Set_Transform(
...
typedef enum FT_Render_Mode_ {
    FT_RENDER_MODE_NORMAL = 0, FT_RENDER_MODE_LIGHT, FT_RENDER_MODE_MONO, FT_RENDER_MODE_LCD, FT_RENDER_MODE_LCD_V,
 ...
 */
FT_EXPORT(FT_Error) FT_Get_Kerning(
 ...
 */
FT_EXPORT(FT_Error) FT_Get_Track_Kerning(
 ...
 */
FT_EXPORT(FT_Error) FT_Get_Glyph_Name(
 ...
 *   in this case.
 */
FT_EXPORT(FT_Error) FT_Select_Charmap(
 ...
 */
FT_EXPORT(FT_Error) FT_Set_Charmap(
 ...
 */
FT_EXPORT(FT_ULong) FT_Get_First_Char(
 ...
 *   charmap.
 */
FT_EXPORT(FT_ULong) FT_Get_Next_Char(
    FT_Face face, FT_ULong char_code, FT_UInt *agindex
);
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Face_Properties(
 ...
 *   The glyph index.  0~means 'undefined character code'.
 */
FT_EXPORT(FT_UInt) FT_Get_Name_Index(
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Get_SubGlyph_Info(
 ...
 *   ```
 */
FT_EXPORT(FT_Bool) FT_Get_Color_Glyph_Layer(
 ...
 *   2.3.6
 */
FT_EXPORT(FT_UInt) FT_Face_GetCharVariantIndex(
 ...
 *   2.3.6
 */
FT_EXPORT(FT_Int) FT_Face_GetCharVariantIsDefault(
    FT_Face face, FT_ULong charcode, FT_ULong variantSelector
);
 ...
 *   2.3.6
 */
FT_EXPORT(FT_UInt32*)FT_Face_GetVariantsOfChar(
    FT_Face face, FT_ULong charcode
);
 ...
 *   2.3.6
 */
FT_EXPORT(FT_UInt32*)FT_Face_GetCharsOfVariant(
 ...
 */
FT_EXPORT(FT_Long) FT_MulDiv(
    FT_Long a, FT_Long b, FT_Long c
);
 ...
 */
FT_EXPORT(void) FT_Vector_Transform(
    FT_Vector *vector, const FT_Matrix *matrix
);
 ...
 */
FT_EXPORT(void) FT_Library_Version(
 ...
 *   2.3.5
 */
FT_EXPORT(FT_Bool) FT_Face_SetUnpatentedHinting(
    FT_Face face, FT_Bool value
);
