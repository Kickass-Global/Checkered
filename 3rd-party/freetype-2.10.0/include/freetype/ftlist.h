 ...
 */
FT_EXPORT(FT_ListNode) FT_List_Find(
 ...
 */
FT_EXPORT(FT_Error) FT_List_Iterate(
...
typedef void
(*FT_List_Destructor)(
    FT_Memory memory, void *data, void *user
);
 ...
 */
FT_EXPORT(void) FT_List_Finalize(
