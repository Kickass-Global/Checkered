 ...
 */
FT_EXPORT(FT_Error) FT_Get_Multi_Master(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FT_Get_MM_Var(
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) FT_Done_MM_Var(
 ...
 *   this bit flag gets unset.
 */
FT_EXPORT(FT_Error) FT_Set_Var_Design_Coordinates(
 ...
 *   2.7.1
 */
FT_EXPORT(FT_Error) FT_Get_Var_Design_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
);
 ...
 *   2.7.1
 */
FT_EXPORT(FT_Error) FT_Get_MM_Blend_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
);
 ...
 */
FT_EXPORT(FT_Error) FT_Set_Var_Blend_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
);
 ...
 *   2.10
 */
FT_EXPORT(FT_Error) FT_Set_MM_WeightVector(
 ...
 *   2.10
 */
FT_EXPORT(FT_Error) FT_Get_MM_WeightVector(
    FT_Face face, FT_UInt *len, FT_Fixed *weightvector
);
 ...
 *   2.8.1
 */
FT_EXPORT(FT_Error) FT_Get_Var_Axis_Flags(
 ...
 *   2.9
 */
FT_EXPORT(FT_Error) FT_Set_Named_Instance(
