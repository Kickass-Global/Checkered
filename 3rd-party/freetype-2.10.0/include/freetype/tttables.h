...
typedef enum FT_Sfnt_Tag_ {
    FT_SFNT_HEAD, FT_SFNT_MAXP, FT_SFNT_OS2, FT_SFNT_HHEA, FT_SFNT_VHEA, FT_SFNT_POST, FT_SFNT_PCLT,
 ...
 *   ```
 */
FT_EXPORT(void*)FT_Get_Sfnt_Table(
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Load_Sfnt_Table(
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Sfnt_Table_Info(
 ...
 *   0xFFFFFFFF.
 */
FT_EXPORT(FT_ULong) FT_Get_CMap_Language_ID(FT_CharMap charmap);
