 ...
 */
FT_EXPORT(FT_Error) FT_Add_Module(
 ...
 */
FT_EXPORT(FT_Module) FT_Get_Module(
 ...
 */
FT_EXPORT(FT_Error) FT_Remove_Module(
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Property_Set(
 ...
 *
 */
FT_EXPORT(FT_Error) FT_Property_Get(
 ...
 *   2.4.2
 */
FT_EXPORT(FT_Error) FT_Reference_Library(FT_Library library);
 ...
 *   @FT_Reference_Library.
 */
FT_EXPORT(FT_Error) FT_New_Library(
 ...
 */
FT_EXPORT(void) FT_Set_Debug_Hook(
...
typedef enum FT_TrueTypeEngineType_ {
    FT_TRUETYPE_ENGINE_TYPE_NONE = 0, FT_TRUETYPE_ENGINE_TYPE_UNPATENTED, FT_TRUETYPE_ENGINE_TYPE_PATENTED
