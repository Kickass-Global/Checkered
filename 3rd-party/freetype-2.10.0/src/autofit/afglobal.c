...
FT_LOCAL_ARRAY_DEF(AF_WritingSystemClass) af_writing_system_classes[] = {
...
FT_LOCAL_ARRAY_DEF(AF_ScriptClass) af_script_classes[] = {
...
FT_LOCAL_ARRAY_DEF(AF_StyleClass) af_style_classes[] = {
...
FT_LOCAL_DEF(FT_Error) af_face_globals_new(
...
FT_LOCAL_DEF(void) af_face_globals_free(AF_FaceGlobals globals) {
...
FT_LOCAL_DEF(FT_Error) af_face_globals_get_metrics(
    AF_FaceGlobals globals, FT_UInt gindex, FT_UInt options, AF_StyleMetrics *ametrics
) {
...
FT_LOCAL_DEF(FT_Bool) af_face_globals_is_digit(
    AF_FaceGlobals globals, FT_UInt gindex
) {
