...
static FT_Error af_indic_metrics_init(
...
static void af_indic_metrics_scale(
...
static FT_Error af_indic_hints_init(
...
static FT_Error af_indic_hints_apply(
...
static void af_indic_get_standard_widths(
