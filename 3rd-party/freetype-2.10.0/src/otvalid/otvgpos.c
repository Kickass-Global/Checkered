...
static void otv_Anchor_validate(
    FT_Bytes table, OTV_Validator valid
);

static void otv_MarkArray_validate(
    FT_Bytes table, OTV_Validator valid
);
...
static void otv_x_sxy(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ValueRecord_validate(
    FT_Bytes table, FT_UInt format, OTV_Validator otvalid
) {
...
static void otv_SinglePos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
    ...
    switch (PosFormat) {
        ...
        case 2:     /* SinglePosFormat2 */
        {
            ...
            otv_Coverage_validate(
                table + Coverage, otvalid, (FT_Int) ValueCount
            );
...
static void otv_PairSet_validate(
    FT_Bytes table, FT_UInt format1, FT_UInt format2, OTV_Validator otvalid
) {
...
static void otv_PairPos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
        ...
        case 1:     /* PairPosFormat1 */
        {
            ...
            for (; PairSetCount > 0; PairSetCount--)
                otv_PairSet_validate(
                    table + FT_NEXT_USHORT(p), ValueFormat1, ValueFormat2, otvalid
                );
        }
            break;
...
static void otv_CursivePos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MarkBasePos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MarkLigPos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MarkMarkPos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ContextPos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ChainContextPos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ExtensionPos_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static const OTV_Validate_Func otv_gpos_validate_funcs[9] = {otv_SinglePos_validate, otv_PairPos_validate,
                                                             otv_CursivePos_validate, otv_MarkBasePos_validate,
                                                             otv_MarkLigPos_validate, otv_MarkMarkPos_validate,
                                                             otv_ContextPos_validate, otv_ChainContextPos_validate,
...
FT_LOCAL_DEF(void) otv_GPOS_subtable_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_GPOS_validate(
    FT_Bytes table, FT_UInt glyph_count, FT_Validator ftvalid
) {
    ...
    otv_LookupList_validate(
        table + LookupList, otvalid
    );
    otv_FeatureList_validate(
        table + FeatureList, table + LookupList, otvalid
    );
    otv_ScriptList_validate(
        table + ScriptList, table + FeatureList, otvalid
    );
