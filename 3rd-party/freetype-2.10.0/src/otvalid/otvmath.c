...
static void otv_MathConstants_validate(
...
static void otv_MathItalicsCorrectionInfo_validate(
    FT_Bytes table, OTV_Validator otvalid, FT_Int isItalic
) {
...
static void otv_MathKern_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MathKernInfo_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MathGlyphInfo_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_GlyphAssembly_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MathGlyphConstruction_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_MATH_validate(
    ...
    otv_MathConstants_validate(
        table + MathConstants, otvalid
    );
    otv_MathGlyphInfo_validate(
        table + MathGlyphInfo, otvalid
    );
    otv_MathVariants_validate(
        table + MathVariants, otvalid
    );
