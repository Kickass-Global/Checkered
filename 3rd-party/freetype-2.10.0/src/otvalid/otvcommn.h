...
typedef void  (*OTV_Validate_Func)(
...
FT_LOCAL(void) otv_Coverage_validate(
...
FT_LOCAL(void) otv_ClassDef_validate(
    FT_Bytes table, OTV_Validator otvalid
);
...
FT_LOCAL(void) otv_Device_validate(
    FT_Bytes table, OTV_Validator otvalid
);
...
FT_LOCAL(void) otv_Lookup_validate(
    FT_Bytes table, OTV_Validator otvalid
);

FT_LOCAL(void) otv_LookupList_validate(
    FT_Bytes table, OTV_Validator otvalid
);
...
FT_LOCAL(void) otv_Feature_validate(
    FT_Bytes table, OTV_Validator otvalid
);

/* lookups must already be validated */
FT_LOCAL(void) otv_FeatureList_validate(
...
FT_LOCAL(void) otv_LangSys_validate(
    FT_Bytes table, OTV_Validator otvalid
);
...
FT_LOCAL(void) otv_Script_validate(
    FT_Bytes table, OTV_Validator otvalid
);

/* features must already be validated */
FT_LOCAL(void) otv_ScriptList_validate(
...
FT_LOCAL(void) otv_x_ux_y_uy_z_uz_p_sp(
    FT_Bytes table, OTV_Validator otvalid
);
...
FT_LOCAL(void) otv_u_O_O_O_O_x_Onx(
    FT_Bytes table, OTV_Validator otvalid
);
