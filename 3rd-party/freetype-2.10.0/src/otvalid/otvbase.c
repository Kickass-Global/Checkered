...
static void otv_BaseCoord_validate(
...
static void otv_BaseTagList_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_BaseValues_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_MinMax_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_BaseScriptList_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_BASE_validate(
    FT_Bytes table, FT_Validator ftvalid
) {
