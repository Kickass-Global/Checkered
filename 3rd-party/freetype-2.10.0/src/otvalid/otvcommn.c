...
FT_LOCAL_DEF(void) otv_Coverage_validate(
    FT_Bytes table, OTV_Validator otvalid, FT_Int expected_count
) {
...
FT_LOCAL_DEF(FT_UInt) otv_Coverage_get_first(FT_Bytes table) {
...
FT_LOCAL_DEF(FT_UInt) otv_Coverage_get_last(FT_Bytes table) {
...
FT_LOCAL_DEF(FT_UInt) otv_Coverage_get_count(FT_Bytes table) {
...
FT_LOCAL_DEF(void) otv_ClassDef_validate(
...
FT_LOCAL_DEF(void) otv_Device_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_Lookup_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_LookupList_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_Feature_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_FeatureList_validate(
    FT_Bytes table, FT_Bytes lookups, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_LangSys_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_Script_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_ScriptList_validate(
    FT_Bytes table, FT_Bytes features, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_u_C_x_Ox(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_x_y_ux_sy(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_x_ux_y_uy_z_uz_p_sp(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_u_O_O_x_Onx(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_u_x_y_Ox_sy(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_u_O_O_O_O_x_Onx(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(void) otv_u_x_Ox_y_Oy_z_Oz_p_sp(
    FT_Bytes table, OTV_Validator otvalid
) {
...
FT_LOCAL_DEF(FT_UInt) otv_GSUBGPOS_get_Lookup_count(FT_Bytes table) {
...
FT_LOCAL_DEF(FT_UInt) otv_GSUBGPOS_have_MarkAttachmentType_flag(FT_Bytes table) {
