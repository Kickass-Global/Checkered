...
static void otv_SingleSubst_validate(
    ...
    switch (SubstFormat) {
        ...
        case 2:     /* SingleSubstFormat2 */
        {
            ...
            otv_Coverage_validate(
                table + Coverage, otvalid, (FT_Int) GlyphCount
            );
...
static void otv_MultipleSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_AlternateSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_Ligature_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_LigatureSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ContextSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ChainContextSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ExtensionSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static void otv_ReverseChainSingleSubst_validate(
    FT_Bytes table, OTV_Validator otvalid
) {
...
static const OTV_Validate_Func otv_gsub_validate_funcs[8] = {otv_SingleSubst_validate, otv_MultipleSubst_validate,
                                                             otv_AlternateSubst_validate, otv_LigatureSubst_validate,
                                                             otv_ContextSubst_validate, otv_ChainContextSubst_validate,
...
FT_LOCAL_DEF(void) otv_GSUB_validate(
