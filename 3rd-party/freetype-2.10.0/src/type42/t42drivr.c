...
static FT_Error t42_get_glyph_name(
    T42_Face face, FT_UInt glyph_index, FT_Pointer buffer, FT_UInt buffer_max
) {
...
static FT_UInt t42_get_name_index(
    T42_Face face, FT_String *glyph_name
) {
...
static FT_Error t42_ps_get_font_info(
...
static FT_Error t42_ps_get_font_extra(
...
static FT_Error t42_ps_get_font_private(
...
static const FT_ServiceDescRec t42_services[] = {{FT_SERVICE_ID_GLYPH_DICT,           &t42_service_glyph_dict},
...
FT_CALLBACK_DEF(FT_Module_Interface) T42_Get_Interface(
    FT_Module module, const FT_String *t42_interface
) {
