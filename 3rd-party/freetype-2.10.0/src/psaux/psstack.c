...
/* `error').                                               */
FT_LOCAL_DEF(CF2_Stack) cf2_stack_init(
    FT_Memory memory, FT_Error *e, FT_UInt stackSize
) {
...
FT_LOCAL_DEF(void) cf2_stack_free(CF2_Stack stack) {
...
FT_LOCAL_DEF(CF2_UInt) cf2_stack_count(CF2_Stack stack) {

    return (CF2_UInt) (stack->top - stack->buffer);
}


FT_LOCAL_DEF(void) cf2_stack_pushInt(
    CF2_Stack stack, CF2_Int val
) {
...
FT_LOCAL_DEF(void) cf2_stack_pushFixed(
    CF2_Stack stack, CF2_Fixed val
) {
...
FT_LOCAL_DEF(CF2_Int) cf2_stack_popInt(CF2_Stack stack) {
...
/* TODO: check this                     */
FT_LOCAL_DEF(CF2_Fixed) cf2_stack_popFixed(CF2_Stack stack) {
...
/* Note: type mismatch is silently cast */
/* TODO: check this                     */
FT_LOCAL_DEF(CF2_Fixed) cf2_stack_getReal(
    CF2_Stack stack, CF2_UInt idx
) {
...
FT_LOCAL_DEF(void) cf2_stack_setReal(
    CF2_Stack stack, CF2_UInt idx, CF2_Fixed val
) {
...
FT_LOCAL_DEF(void) cf2_stack_pop(
    CF2_Stack stack, CF2_UInt num
) {
...
FT_LOCAL_DEF(void) cf2_stack_roll(
    CF2_Stack stack, CF2_Int count, CF2_Int shift
) {
...
FT_LOCAL_DEF(void) cf2_stack_clear(CF2_Stack stack) {
