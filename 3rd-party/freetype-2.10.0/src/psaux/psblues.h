 ...
 */
enum {
    CF2_ICF_Top = cf2_intToFixed(880), CF2_ICF_Bottom = cf2_intToFixed(-120)
};
...
enum {
    CF2_MAX_BLUES = 7, CF2_MAX_OTHERBLUES = 5
};
...
FT_LOCAL(void) cf2_blues_init(
    CF2_Blues blues, CF2_Font font
);

FT_LOCAL(FT_Bool) cf2_blues_capture(
