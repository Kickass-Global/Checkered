...
FT_LOCAL_DEF(void) cf2_arrstack_init(
    CF2_ArrStack arrstack, FT_Memory memory, FT_Error *error, size_t sizeItem
) {
...
FT_LOCAL_DEF(void) cf2_arrstack_finalize(CF2_ArrStack arrstack) {
...
static FT_Bool cf2_arrstack_setNumElements(
    CF2_ArrStack arrstack, size_t numElements
) {
...
FT_LOCAL_DEF(void) cf2_arrstack_setCount(
    CF2_ArrStack arrstack, size_t numElements
) {
...
/* clear the count */
FT_LOCAL_DEF(void) cf2_arrstack_clear(CF2_ArrStack arrstack) {
...
FT_LOCAL_DEF(size_t) cf2_arrstack_size(const CF2_ArrStack arrstack) {
...
FT_LOCAL_DEF(void*)cf2_arrstack_getBuffer(const CF2_ArrStack arrstack) {
...
FT_LOCAL_DEF(void*)cf2_arrstack_getPointer(
    const CF2_ArrStack arrstack, size_t idx
) {
...
FT_LOCAL_DEF(void) cf2_arrstack_push(
    CF2_ArrStack arrstack, const void *ptr
) {
