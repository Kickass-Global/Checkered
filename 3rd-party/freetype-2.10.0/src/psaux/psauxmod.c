...
const PS_Table_FuncsRec ps_table_funcs = {ps_table_new,     /* init    */
                                          ps_table_done,    /* done    */
                                          ps_table_add,     /* add     */
...
FT_CALLBACK_TABLE_DEF
const PS_Parser_FuncsRec ps_parser_funcs = {ps_parser_init,             /* init             */
                                            ps_parser_done,             /* done             */
...
FT_CALLBACK_TABLE_DEF
const PS_Builder_FuncsRec ps_builder_funcs = {ps_builder_init,          /* init */
                                              ps_builder_done           /* done */
};


FT_CALLBACK_TABLE_DEF
const T1_Builder_FuncsRec t1_builder_funcs = {t1_builder_init,          /* init */
...
FT_CALLBACK_TABLE_DEF
const T1_Decoder_FuncsRec t1_decoder_funcs = {t1_decoder_init,               /* init                  */
...
#ifndef T1_CONFIG_OPTION_NO_AFM
FT_CALLBACK_TABLE_DEF
const AFM_Parser_FuncsRec afm_parser_funcs = {afm_parser_init,  /* init  */
...
FT_CALLBACK_TABLE_DEF
const T1_CMap_ClassesRec t1_cmap_classes = {&t1_cmap_standard_class_rec, &t1_cmap_expert_class_rec,
                                            &t1_cmap_custom_class_rec, &t1_cmap_unicode_class_rec};


FT_CALLBACK_TABLE_DEF
const CFF_Builder_FuncsRec cff_builder_funcs = {cff_builder_init,          /* init */
...
FT_CALLBACK_TABLE_DEF
const CFF_Decoder_FuncsRec cff_decoder_funcs = {cff_decoder_init,              /* init    */
...
static const PSAux_Interface psaux_interface = {&ps_table_funcs, &ps_parser_funcs, &t1_builder_funcs, &t1_decoder_funcs,
                                                t1_decrypt, cff_random, ps_decoder_init, t1_make_subfont,
...
FT_CALLBACK_TABLE_DEF
const FT_Module_Class psaux_module_class = {0, sizeof(FT_ModuleRec), "psaux", 0x20000L, 0x20000L,
