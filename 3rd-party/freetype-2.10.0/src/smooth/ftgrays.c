 ...
 */
static void gray_set_cell(
    RAS_ARG_ TCoord ex, TCoord ey
) {
 ...
 */
static void gray_render_line(
    RAS_ARG_ TPos to_x, TPos to_y
) {
...
static void gray_render_conic(
    RAS_ARG_ const FT_Vector *control, const FT_Vector *to
) {
...
static void gray_render_cubic(
    RAS_ARG_ const FT_Vector *control1, const FT_Vector *control2, const FT_Vector *to
) {
...
static int gray_conic_to(
    const FT_Vector *control, const FT_Vector *to, gray_PWorker worker
) {
...
static int gray_cubic_to(
    const FT_Vector *control1, const FT_Vector *control2, const FT_Vector *to, gray_PWorker worker
) {
...
static void gray_hline(
    RAS_ARG_ TCoord x, TCoord y, TArea coverage, TCoord acount
) {
...
static int gray_raster_new(
    FT_Memory memory, FT_Raster *araster
) {
...
static void gray_raster_reset(
    FT_Raster raster, unsigned char *pool_base, unsigned long pool_size
) {
...
static int gray_raster_set_mode(
    FT_Raster raster, unsigned long mode, void *args
) {
