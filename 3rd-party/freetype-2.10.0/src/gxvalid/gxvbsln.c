...
static void gxv_bsln_LookupValue_validate(
...
static void gxv_bsln_parts_fmt0_validate(
    FT_Bytes tables, FT_Bytes limit, GXV_Validator gxvalid
) {
...
static void gxv_bsln_parts_fmt1_validate(
    FT_Bytes tables, FT_Bytes limit, GXV_Validator gxvalid
) {
    ...
    gxv_LookupTable_validate(
        p + 2 * GXV_BSLN_VALUE_COUNT, limit, gxvalid
    );
...
static void gxv_bsln_parts_fmt2_validate(
    FT_Bytes tables, FT_Bytes limit, GXV_Validator gxvalid
) {
...
static void gxv_bsln_parts_fmt3_validate(
    ...
    gxvalid->lookupfmt4_trans = gxv_bsln_LookupFmt4_transit;
    gxv_LookupTable_validate(
        p + (2 + 2 * GXV_BSLN_VALUE_COUNT), limit, gxvalid
    );
...
FT_LOCAL_DEF(void) gxv_bsln_validate(
    ...
    GXV_Validate_Func fmt_funcs_table[] = {gxv_bsln_parts_fmt0_validate, gxv_bsln_parts_fmt1_validate,
                                           gxv_bsln_parts_fmt2_validate, gxv_bsln_parts_fmt3_validate,};
