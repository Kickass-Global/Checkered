...
static void gxv_morx_subtable_type0_entry_validate(
    FT_UShort state, FT_UShort flags, GXV_XStateTable_GlyphOffsetCPtr glyphOffset_p, FT_Bytes table, FT_Bytes limit,
...
FT_LOCAL_DEF(void) gxv_morx_subtable_type0_validate(
