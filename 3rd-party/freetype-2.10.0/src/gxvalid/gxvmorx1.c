...
static void gxv_morx_subtable_type1_substitutionTable_load(
...
static void gxv_morx_subtable_type1_subtable_setup(
 ...
 **/
static void gxv_morx_subtable_type1_substitutionTable_validate(
    FT_Bytes table, FT_Bytes limit, GXV_Validator gxvalid
) {
 ...
 */
FT_LOCAL_DEF(void) gxv_morx_subtable_type1_validate(
    FT_Bytes table, FT_Bytes limit, GXV_Validator gxvalid
) {
