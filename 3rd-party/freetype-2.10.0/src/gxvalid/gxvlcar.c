...
static void gxv_lcar_partial_validate(
    FT_Short partial, FT_UShort glyph, GXV_Validator gxvalid
) {
...
static void gxv_lcar_LookupValue_validate(
...
FT_LOCAL_DEF(void) gxv_lcar_validate(
