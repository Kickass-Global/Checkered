...
static void gxv_morx_subtables_validate(
    FT_Bytes table, FT_Bytes limit, FT_UShort nSubtables, GXV_Validator gxvalid
) {

    FT_Bytes p = table;

    GXV_Validate_Func fmt_funcs_table[] = {gxv_morx_subtable_type0_validate, /* 0 */
...
static void gxv_morx_chain_validate(
    ...
    gxv_morx_subtables_validate(
        p, table + chainLength, (FT_UShort) nSubtables, gxvalid
    );
...
FT_LOCAL_DEF(void) gxv_morx_validate(
