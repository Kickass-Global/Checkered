...
static void gxv_mort_feature_validate(
    GXV_mort_feature f, GXV_Validator gxvalid
) {
 ...
 */
FT_LOCAL_DEF(void) gxv_mort_featurearray_validate(
    FT_Bytes table, FT_Bytes limit, FT_ULong nFeatureFlags, GXV_Validator gxvalid
) {
...
FT_LOCAL_DEF(void) gxv_mort_coverage_validate(
    FT_UShort coverage, GXV_Validator gxvalid
) {
...
static void gxv_mort_subtables_validate(
    FT_Bytes table, FT_Bytes limit, FT_UShort nSubtables, GXV_Validator gxvalid
) {

    FT_Bytes p = table;

    GXV_Validate_Func fmt_funcs_table[] = {gxv_mort_subtable_type0_validate, /* 0 */
...
static void gxv_mort_chain_validate(
    ...
    gxv_mort_featurearray_validate(
        p, table + chainLength, nFeatureFlags, gxvalid
    );
...
FT_LOCAL_DEF(void) gxv_mort_validate(
