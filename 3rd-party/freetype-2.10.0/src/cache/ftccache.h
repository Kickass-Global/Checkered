...
typedef FT_Error
(*FTC_Node_NewFunc)(
    FTC_Node *pnode, FT_Pointer query, FTC_Cache cache
);
...
(*FTC_Node_CompareFunc)(
    FTC_Node node, FT_Pointer key, FTC_Cache cache, FT_Bool *list_changed
);
...
FT_LOCAL(FT_Error) FTC_Cache_NewNode(
 ...
 */
FT_LOCAL(void) FTC_Cache_RemoveFaceID(
