...
FT_LOCAL_DEF(void) cid_slot_done(FT_GlyphSlot slot) {

    slot->internal->glyph_hints = NULL;
}


FT_LOCAL_DEF(FT_Error) cid_slot_init(FT_GlyphSlot slot) {
...
FT_LOCAL_DEF(void) cid_size_done(FT_Size cidsize)         /* CID_Size */
{
...
FT_LOCAL_DEF(FT_Error) cid_size_init(FT_Size cidsize)     /* CID_Size */
{
...
FT_LOCAL(FT_Error) cid_size_request(
 ...
 */
FT_LOCAL_DEF(void) cid_face_done(FT_Face cidface)         /* CID_Face */
{
 ...
 */
FT_LOCAL_DEF(FT_Error) cid_face_init(
    FT_Stream stream, FT_Face cidface,        /* CID_Face */
