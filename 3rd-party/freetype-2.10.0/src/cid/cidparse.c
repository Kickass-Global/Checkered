...
FT_LOCAL_DEF(FT_Error) cid_parser_new(
    CID_Parser *parser, FT_Stream stream, FT_Memory memory, PSAux_Service psaux
) {
...
FT_LOCAL_DEF(void) cid_parser_done(CID_Parser *parser) {
