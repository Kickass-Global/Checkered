...
static FT_Error ft_lzw_file_init(
    FT_LZWFile zip, FT_Stream stream, FT_Stream source
) {
...
static FT_Error ft_lzw_file_skip_output(
    FT_LZWFile zip, FT_ULong count
) {
...
static FT_ULong ft_lzw_file_io(
    FT_LZWFile zip, FT_ULong pos, FT_Byte *buffer, FT_ULong count
) {
...
static unsigned long ft_lzw_stream_io(
...
FT_EXPORT_DEF(FT_Error) FT_Stream_OpenLZW(
