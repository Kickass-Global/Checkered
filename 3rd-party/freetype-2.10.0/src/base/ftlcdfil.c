...
FT_BASE_DEF (void) ft_lcd_padding(
...
FT_EXPORT_DEF(FT_Error) FT_Library_SetLcdFilterWeights(
    FT_Library library, unsigned char *weights
) {
...
FT_EXPORT_DEF(FT_Error) FT_Library_SetLcdFilter(
    FT_Library library, FT_LcdFilter filter
) {
...
FT_EXPORT_DEF(FT_Error) FT_Library_SetLcdGeometry(
    FT_Library library, FT_Vector sub[3]
) {
