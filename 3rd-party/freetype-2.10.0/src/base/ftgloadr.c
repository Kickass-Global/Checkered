...
FT_BASE_DEF(FT_Error) FT_GlyphLoader_New(
    FT_Memory memory, FT_GlyphLoader *aloader
) {
...
FT_BASE_DEF(FT_Error) FT_GlyphLoader_CreateExtra(FT_GlyphLoader loader) {
...
/*                                                                       */
FT_BASE_DEF(FT_Error) FT_GlyphLoader_CheckPoints(
    FT_GlyphLoader loader, FT_UInt n_points, FT_UInt n_contours
) {
...
/*                                                                  */
FT_BASE_DEF(FT_Error) FT_GlyphLoader_CheckSubGlyphs(
    FT_GlyphLoader loader, FT_UInt n_subs
) {
