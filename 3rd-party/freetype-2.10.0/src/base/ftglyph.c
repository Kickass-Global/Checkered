...
FT_CALLBACK_DEF(FT_Error) ft_bitmap_glyph_init(
    FT_Glyph bitmap_glyph, FT_GlyphSlot slot
) {
...
FT_CALLBACK_DEF(FT_Error) ft_bitmap_glyph_copy(
    FT_Glyph bitmap_source, FT_Glyph bitmap_target
) {
...
FT_CALLBACK_DEF(void) ft_bitmap_glyph_bbox(
    FT_Glyph bitmap_glyph, FT_BBox *cbox
) {
...
FT_CALLBACK_DEF(FT_Error) ft_outline_glyph_init(
    FT_Glyph outline_glyph, FT_GlyphSlot slot
) {
    ...
    error = FT_Outline_New(
        library, (FT_UInt) source->n_points, source->n_contours, &glyph->outline
    );
    if (error)
        goto Exit;
...
FT_CALLBACK_DEF(FT_Error) ft_outline_glyph_copy(
    FT_Glyph outline_source, FT_Glyph outline_target
) {
    ...
    error = FT_Outline_New(
        library, (FT_UInt) source->outline.n_points, source->outline.n_contours, &target->outline
    );
    if (!error)
...
FT_CALLBACK_DEF(void) ft_outline_glyph_transform(
    FT_Glyph outline_glyph, const FT_Matrix *matrix, const FT_Vector *delta
) {
...
FT_CALLBACK_DEF(void) ft_outline_glyph_bbox(
    FT_Glyph outline_glyph, FT_BBox *bbox
) {
...
FT_CALLBACK_DEF(FT_Error) ft_outline_glyph_prepare(
    FT_Glyph outline_glyph, FT_GlyphSlot slot
) {
...
static FT_Error ft_new_glyph(
    FT_Library library, const FT_Glyph_Class *clazz, FT_Glyph *aglyph
) {
...
FT_EXPORT_DEF(FT_Error) FT_Glyph_Copy(
    FT_Glyph source, FT_Glyph *target
) {
...
FT_EXPORT(FT_Error) FT_New_Glyph(
    FT_Library library, FT_Glyph_Format format, FT_Glyph *aglyph
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_Glyph(
    FT_GlyphSlot slot, FT_Glyph *aglyph
) {
...
FT_EXPORT_DEF(FT_Error) FT_Glyph_Transform(
    FT_Glyph glyph, FT_Matrix *matrix, FT_Vector *delta
) {
...
FT_EXPORT_DEF(void) FT_Glyph_Get_CBox(
...
FT_EXPORT_DEF(FT_Error) FT_Glyph_To_Bitmap(
    FT_Glyph *the_glyph, FT_Render_Mode render_mode, FT_Vector *origin, FT_Bool destroy
) {
