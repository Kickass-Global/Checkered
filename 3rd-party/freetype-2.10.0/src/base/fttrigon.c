...
static const FT_Angle ft_trig_arctan_table[] = {1740967L, 919879L, 466945L, 234379L, 117304L, 58666L, 29335L, 14668L,
                                                7334L, 3667L, 1833L, 917L, 458L, 229L, 115L, 57L, 29L, 14L, 7L, 4L, 2L,
                                                1L};
...
static void ft_trig_pseudo_rotate(
    FT_Vector *vec, FT_Angle theta
) {
...
FT_EXPORT_DEF(FT_Angle) FT_Atan2(
    FT_Fixed dx, FT_Fixed dy
) {
...
FT_EXPORT_DEF(void) FT_Vector_Unit(
    FT_Vector *vec, FT_Angle angle
) {
...
FT_EXPORT_DEF(void) FT_Vector_Rotate(
    FT_Vector *vec, FT_Angle angle
) {
...
FT_EXPORT_DEF(void) FT_Vector_Polarize(
    FT_Vector *vec, FT_Fixed *length, FT_Angle *angle
) {
...
FT_EXPORT_DEF(void) FT_Vector_From_Polar(
    FT_Vector *vec, FT_Fixed length, FT_Angle angle
) {
...
FT_EXPORT_DEF(FT_Angle) FT_Angle_Diff(
