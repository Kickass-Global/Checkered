...
FT_BASE_DEF(FT_Fixed) FT_Hypot(
    FT_Fixed x, FT_Fixed y
) {
...
FT_EXPORT_DEF(FT_Long) FT_MulDiv(
...
FT_BASE_DEF(FT_Long) FT_MulDiv_No_Round(
    FT_Long a_, FT_Long b_, FT_Long c_
) {
...
FT_EXPORT_DEF(FT_Long) FT_MulFix(
    FT_Long a_, FT_Long b_
) {
...
FT_EXPORT_DEF(FT_Long) FT_DivFix(
    FT_Long a_, FT_Long b_
) {
...
FT_EXPORT_DEF(void) FT_Matrix_Multiply(
    const FT_Matrix *a, FT_Matrix *b
) {
...
FT_BASE_DEF(void) FT_Matrix_Multiply_Scaled(
    const FT_Matrix *a, FT_Matrix *b, FT_Long scaling
) {
...
FT_BASE_DEF(void) FT_Vector_Transform_Scaled(
    FT_Vector *vector, const FT_Matrix *matrix, FT_Long scaling
) {
...
FT_BASE_DEF(FT_Int) ft_corner_orientation(
    FT_Pos in_x, FT_Pos in_y, FT_Pos out_x, FT_Pos out_y
) {
...
FT_BASE_DEF(FT_Int) ft_corner_is_flat(
    FT_Pos in_x, FT_Pos in_y, FT_Pos out_x, FT_Pos out_y
) {
