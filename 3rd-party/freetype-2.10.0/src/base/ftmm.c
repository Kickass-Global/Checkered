...
static FT_Error ft_face_get_mm_service(
    FT_Face face, FT_Service_MultiMasters *aservice
) {
...
static FT_Error ft_face_get_mvar_service(
    FT_Face face, FT_Service_MetricsVariations *aservice
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_Multi_Master(
    FT_Face face, FT_Multi_Master *amaster
) {
...
FT_EXPORT_DEF(FT_Error) FT_Done_MM_Var(
    FT_Library library, FT_MM_Var *amaster
) {
...
FT_EXPORT_DEF(FT_Error) FT_Set_MM_Design_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Long *coords
) {
...
FT_EXPORT_DEF(FT_Error) FT_Set_MM_WeightVector(
    FT_Face face, FT_UInt len, FT_Fixed *weightvector
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_MM_WeightVector(
    FT_Face face, FT_UInt *len, FT_Fixed *weightvector
) {
...
FT_EXPORT_DEF(FT_Error) FT_Set_Var_Design_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_Var_Design_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
) {
...
FT_EXPORT_DEF(FT_Error) FT_Set_Var_Blend_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_MM_Blend_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_Var_Blend_Coordinates(
    FT_Face face, FT_UInt num_coords, FT_Fixed *coords
) {
...
FT_EXPORT_DEF(FT_Error) FT_Get_Var_Axis_Flags(
...
FT_EXPORT_DEF(FT_Error) FT_Set_Named_Instance(
    FT_Face face, FT_UInt instance_index
) {
