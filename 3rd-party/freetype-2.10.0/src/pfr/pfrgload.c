...
FT_LOCAL_DEF(void) pfr_glyph_init(
    PFR_Glyph glyph, FT_GlyphLoader loader
) {
...
FT_LOCAL_DEF(void) pfr_glyph_done(PFR_Glyph glyph) {
...
static FT_Error pfr_glyph_line_to(
    PFR_Glyph glyph, FT_Vector *to
) {
...
static FT_Error pfr_glyph_curve_to(
    PFR_Glyph glyph, FT_Vector *control1, FT_Vector *control2, FT_Vector *to
) {
...
static FT_Error pfr_glyph_move_to(
    PFR_Glyph glyph, FT_Vector *to
) {
...
/* load a simple glyph */
static FT_Error pfr_glyph_load_simple(
    PFR_Glyph glyph, FT_Byte *p, FT_Byte *limit
) {
...
static FT_Error pfr_glyph_load_compound(
    PFR_Glyph glyph, FT_Byte *p, FT_Byte *limit
) {
...
static FT_Error pfr_glyph_load_rec(
    PFR_Glyph glyph, FT_Stream stream, FT_ULong gps_offset, FT_ULong offset, FT_ULong size
) {
    ...
    if (size > 0 && *p & PFR_GLYPH_IS_COMPOUND) {
        ...
        for (n = 0; n < count; n++) {
            ...
            error = pfr_glyph_load_rec(
                glyph, stream, gps_offset, subglyph->gps_offset, subglyph->gps_size
            );
            if (error)
                break;
...
FT_LOCAL_DEF(FT_Error) pfr_glyph_load(
    PFR_Glyph glyph, FT_Stream stream, FT_ULong gps_offset, FT_ULong offset, FT_ULong size
) {
