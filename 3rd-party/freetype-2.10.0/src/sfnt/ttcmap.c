...
FT_CALLBACK_DEF(FT_Error) tt_cmap_init(
    TT_CMap cmap, FT_Byte *table
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap0_validate(
    FT_Byte *table, FT_Validator valid
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap0_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap0_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap0_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap2_validate(
    FT_Byte *table, FT_Validator valid
) {
...
static FT_Byte *tt_cmap2_get_subheader(
    FT_Byte *table, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap2_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap2_char_next(
...
FT_CALLBACK_DEF(FT_Error) tt_cmap2_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap4_init(
    TT_CMap4 cmap, FT_Byte *table
) {
...
static FT_Int tt_cmap4_set_range(
    TT_CMap4 cmap, FT_UInt range_index
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap4_validate(
    FT_Byte *table, FT_Validator valid
) {
...
static FT_UInt tt_cmap4_char_map_linear(
    TT_CMap cmap, FT_UInt32 *pcharcode, FT_Bool next
) {
...
static FT_UInt tt_cmap4_char_map_binary(
    TT_CMap cmap, FT_UInt32 *pcharcode, FT_Bool next
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap4_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap4_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap4_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap6_validate(
    FT_Byte *table, FT_Validator valid
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap6_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap6_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap6_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap8_validate(
    FT_Byte *table, FT_Validator valid
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap8_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap8_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap8_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap10_validate(
    FT_Byte *table, FT_Validator valid
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap10_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap10_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap10_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap12_init(
    TT_CMap12 cmap, FT_Byte *table
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap12_validate(
    FT_Byte *table, FT_Validator valid
) {
...
static FT_UInt tt_cmap12_char_map_binary(
    TT_CMap cmap, FT_UInt32 *pchar_code, FT_Bool next
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap12_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap13_init(
    TT_CMap13 cmap, FT_Byte *table
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap13_validate(
    FT_Byte *table, FT_Validator valid
) {
...
static FT_UInt tt_cmap13_char_map_binary(
    TT_CMap cmap, FT_UInt32 *pchar_code, FT_Bool next
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap13_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap13_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap13_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
FT_CALLBACK_DEF(void) tt_cmap14_done(TT_CMap14 cmap) {
...
static FT_Error tt_cmap14_ensure(
    TT_CMap14 cmap, FT_UInt32 num_results, FT_Memory memory
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap14_init(
    TT_CMap14 cmap, FT_Byte *table
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap14_validate(
    FT_Byte *table, FT_Validator valid
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap14_char_index(
    TT_CMap cmap, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap14_char_next(
    TT_CMap cmap, FT_UInt32 *pchar_code
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap14_get_info(
    TT_CMap cmap, TT_CMapInfo *cmap_info
) {
...
static FT_UInt tt_cmap14_char_map_def_binary(
    FT_Byte *base, FT_UInt32 char_code
) {
...
static FT_UInt tt_cmap14_char_map_nondef_binary(
    FT_Byte *base, FT_UInt32 char_code
) {
...
static FT_Byte *tt_cmap14_find_variant(
    FT_Byte *base, FT_UInt32 variantCode
) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap14_char_var_index(
    ...
    if (nondefOff != 0)
        return tt_cmap14_char_map_nondef_binary(
            cmap->data + nondefOff, charcode
        );
...
FT_CALLBACK_DEF(FT_Int) tt_cmap14_char_var_isdefault(
    TT_CMap cmap, FT_UInt32 charcode, FT_UInt32 variantSelector
) {
    ...
    if (nondefOff != 0 && tt_cmap14_char_map_nondef_binary(
        cmap->data + nondefOff, charcode
    ) != 0)
        return 0;
...
FT_CALLBACK_DEF(FT_UInt32*)tt_cmap14_variants(
    TT_CMap cmap, FT_Memory memory
) {
...
FT_CALLBACK_DEF(FT_UInt32 *)tt_cmap14_char_variants(
    TT_CMap cmap, FT_Memory memory, FT_UInt32 charCode
) {
    ...
    for (q = cmap14->results; count > 0; count--) {
        ...
        if ((defOff != 0 && tt_cmap14_char_map_def_binary(
            cmap->data + defOff, charCode
...
FT_CALLBACK_DEF(FT_UInt32 *)tt_cmap14_variant_chars(
    TT_CMap cmap, FT_Memory memory, FT_UInt32 variantSelector
) {

    FT_Byte *p = tt_cmap14_find_variant(
        cmap->data + 6, variantSelector
    );
    FT_Int i;
    FT_ULong defOff;
    FT_ULong nondefOff;
    ...
    if (defOff == 0)
        return tt_cmap14_get_nondef_chars(
            cmap, cmap->data + nondefOff, memory
        );
    else if (nondefOff == 0)
        return tt_cmap14_get_def_chars(
            cmap, cmap->data + defOff, memory
        );
    else {
...
/* Format 14 extension functions */
                  ...
                  (FT_CMap_VariantListFunc) tt_cmap14_variants, (FT_CMap_CharVariantListFunc) tt_cmap14_char_variants,
...
FT_CALLBACK_DEF(const char *)tt_get_glyph_name(
    TT_Face face, FT_UInt idx
) {
...
FT_CALLBACK_DEF(FT_Error) tt_cmap_unicode_init(
    PS_Unicodes unicodes, FT_Pointer pointer
) {
    ...
    return psnames->unicodes_init(
        memory, unicodes, face->root.num_glyphs, (PS_GetGlyphNameFunc) &tt_get_glyph_name, (PS_FreeGlyphNameFunc) NULL,
        (FT_Pointer) face
    );
}


FT_CALLBACK_DEF(void) tt_cmap_unicode_done(PS_Unicodes unicodes) {
...
FT_CALLBACK_DEF(FT_UInt) tt_cmap_unicode_char_index(
    PS_Unicodes unicodes, FT_UInt32 char_code
) {
...
FT_CALLBACK_DEF(FT_UInt32) tt_cmap_unicode_char_next(
    PS_Unicodes unicodes, FT_UInt32 *pchar_code
) {
...
/* in the current face                                                */
/*                                                                    */
FT_LOCAL_DEF(FT_Error) tt_face_build_cmaps(TT_Face face) {
...
FT_LOCAL(FT_Error) tt_get_cmap_info(
    FT_CharMap charmap, TT_CMapInfo *cmap_info
) {
