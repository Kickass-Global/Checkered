...
static FT_Error load_format_20(
    TT_Face face, FT_Stream stream, FT_ULong post_limit
) {
...
FT_LOCAL_DEF(void) tt_face_free_ps_names(TT_Face face) {
 ...
 */
FT_LOCAL_DEF(FT_Error) tt_face_get_ps_name(
