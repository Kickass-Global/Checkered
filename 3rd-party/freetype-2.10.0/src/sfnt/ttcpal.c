...
FT_LOCAL_DEF(FT_Error) tt_face_load_cpal(
...
FT_LOCAL_DEF(void) tt_face_free_cpal(TT_Face face) {
...
FT_LOCAL_DEF(FT_Error) tt_face_palette_set(
    TT_Face face, FT_UInt palette_index
) {
