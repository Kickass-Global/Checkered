...
APTR Alloc_VecPooled(
    APTR poolHeader, ULONG memSize
) {
...
/*                                                                       */
FT_CALLBACK_DEF(void) ft_amiga_stream_close(FT_Stream stream) {
...
/*                                                                       */
FT_CALLBACK_DEF(unsigned long) ft_amiga_stream_io(
