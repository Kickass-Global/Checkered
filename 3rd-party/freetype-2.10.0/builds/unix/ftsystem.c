...
/*                                                                       */
FT_CALLBACK_DEF(void*)ft_realloc(
...
/*                                                                       */
FT_CALLBACK_DEF(void) ft_free(
    FT_Memory memory, void *block
) {
...
/*                                                                       */
FT_CALLBACK_DEF(void) ft_close_stream_by_munmap(FT_Stream stream) {
...
/*    stream :: A pointer to the stream object.                          */
/*                                                                       */
FT_CALLBACK_DEF(void) ft_close_stream_by_free(FT_Stream stream) {
...
FT_BASE_DEF(FT_Error) FT_Stream_Open(
    ...
    if ((long) stream->base != -1 && stream->base != NULL)
        ...
        do {
            ...
            read_count = read(
                file, stream->base + total_read_count, stream->size - total_read_count
            );
