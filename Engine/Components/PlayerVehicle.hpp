...
struct Player : public ComponentBase {
  ...
  Player() {
    ...
    auto car_front_bumper =
        getEngine()->getSubSystem<Pipeline::Library>()->getAsset<Mesh>(
            "Assets/Meshes/car_front_bumper.obj");
    auto car_back_bumper =
        getEngine()->getSubSystem<Pipeline::Library>()->getAsset<Mesh>(
    ...
    player_damage_model->parts.push_back(
        Component::Model::Part{{}, 0, "chassis", 0, 100, true});
    player_damage_model->parts.push_back(
        Component::Model::Part{{}, 0, "car_left_mirror", 0, 5});
    player_damage_model->parts.push_back(
        Component::Model::Part{{}, 0, "car_right_mirror", 0, 5});
    player_damage_model->parts.push_back(
        Component::Model::Part{{}, 0, "car_front_bumper", 0, 40});
    player_damage_model->parts.push_back(
        Component::Model::Part{{}, 0, "car_back_bumper", 0, 40});
    player_damage_model->parts.push_back(
        Component::Model::Part{{}, 0, "car_liscense", 0, 5});
    ...
    player_damage_model->parts[3].variations.push_back(
        Component::Model::Variation{
            40, getEngine()->createComponent<PaintedMesh>(car_front_bumper,
                                                          car_material)});

    player_damage_model->parts[4].variations.push_back(
        Component::Model::Variation{
            40, getEngine()->createComponent<PaintedMesh>(car_back_bumper,
                                                          car_material)});

    player_damage_model->parts[5].variations.push_back(
        Component::Model::Variation{
