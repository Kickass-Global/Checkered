...
namespace Rendering {
    ...
    public:
        ...
        void updateInstanceData(
            std::shared_ptr<Mesh> &mesh_id, std::shared_ptr<Material> &material_id, int size, float *data, int stride
        );
        ...
        std::shared_ptr<Rendering::GeometryBatch> findSuitableBufferFor(
            std::shared_ptr<Mesh> &data, std::shared_ptr<Material> &material
        );
