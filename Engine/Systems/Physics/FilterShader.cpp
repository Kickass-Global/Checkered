...
PxFilterFlags Physics::FilterShader::setupFilterShader(
  ...
  if (PxFilterObjectIsTrigger(attributes0) ||
    ...
    if ((filterData0.word0 & filterData1.word1) &&
        (filterData0.word1 & filterData1.word0)) {
...
void Physics::FilterShader::setupQueryFiltering(PxRigidActor *actor,
                                                PxU32 filterGroup,
                                                PxU32 filterMask) {
...
void Physics::FilterShader::setupFiltering(PxRigidActor *actor,
                                           PxU32 filterGroup,
                                           PxU32 filterMask) {
